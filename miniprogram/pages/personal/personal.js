...
Page({
  ...
  set_article(){
    ...
    var update_CN = "V1.2.2版本更新内容：\n（1）新增预约其他时间段功能，时间需要写在备注内（要咨询的问题）\n（2）预约可撤回功能\n（3）登录图标指引优化\n（4）修改其他已知问题"
    var update_EN = "V1.2.2 Update:\n(1)Add the function of booking other time periods, and the time needs to be written in the remarks.\n(2)Reservation revocation function.\n(3)Login icon guide optimization.\n(4)Fix other known problems. "
    const app = getApp()
